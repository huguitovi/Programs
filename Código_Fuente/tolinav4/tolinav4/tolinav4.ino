...
#define Ymin 0
#define Ymed 512  //386
#define Yumbral 50  //real 126
#define Ymax 999 //ok

#define Zmin 0 // 312
#define Zmed 512 //480
#define Zumbral 50 //70 //real 50
#define Zmax 999  //796

#define Wmin 0
#define Wmed 512   // 646
#define Wumbral 50  //220 //real 209
#define Wmax 999 //1024
...
void loop(){ //eje: x=1; y=2; z=3, giro = 4 sentido; 1=adelante/horario ; -1=atras/antihorario ; visto desde techo de carpa 
  ...
  boolean msjok = true;
  boolean barra = false;
  char payload[14];// = "000000000000/"; // = "527100320900/"; //"123456789666/";
  int i = 0; 

  
  /*while(Serial.available()>0 && barra == false){
    
    payload[i] = Serial.read();
    if(payload[i] == '/') barra = true;
      //Serial.println(Serial.read() - '0');
      i++;
    //Serial.println("entra a Serial.available"); 
  }
  Serial.print("contador i llego hasta:  ");
  Serial.println(i);
  ...
  delay(2000);
    ...
    if(payload[12] != '/'){
      Serial.println("Error de fin de comando = "); 
      msjok = false;
    }
