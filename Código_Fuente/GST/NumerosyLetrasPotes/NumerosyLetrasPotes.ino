...
//aca cambias al valor maximo que muestre en pantalla agregar el ".0" es necesario por el tipo de variable Float
...
void loop() {
  ...
  //(para esto hay que saber que en ASCII esto es desde los enteros 65 hasta 90)
  ...
  // convierto con regla de tres simple el valor de 0 a 1023 en A hasta Z
  //(para esto hay que saber que en ASCII esto es desde los enteros 65 hasta 90)
 //auxiliar de cuenta para convertir a caracter
  f = (25 / MaximoY) * val3;
  thisByte = round(f) + 65;
  ...
  Serial.println(",");
  val1 = 0;  // importante reiniciar los valores para el nuevo filtrado
  val3 = 0;
