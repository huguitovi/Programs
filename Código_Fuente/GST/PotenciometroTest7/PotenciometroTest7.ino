// Emulador disponible en: https://www.tinkercad.com/things/3AbcvOwmZ8W-fantastic-hillar/editel?sharecode=VciTTZfQid4AT4AJQIa9BwnldmDSHNpmpxiZzNXoT6c
...
void loop() {
  ...
  w2 = w / 10 - w1 * 10 ;
  w3 = w  - w2 * 10 - w1 * 100;
  Serial.print(w1);  Serial.print(w2);  Serial.print(w3);
  k = 0;
